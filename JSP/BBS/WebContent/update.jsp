...
<body>
	<%
		...
		if(userID == null){
			...
			outter.println("alert('먼저 로그인을 해야합니다!')");
			...
			<form method="post" action="updateAction.jsp?bbsID=<%= bbsID %>">
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd;">
					...
					<tbody>
						...
						<tr>
							<td><textarea class="form-control" placeholder="글 내용" name="bbsContent" maxlength="2048" style="height:250px"><%= bbs.getBbsContent() %></textarea></td>
						</tr>
					</tbody>
				</table>
